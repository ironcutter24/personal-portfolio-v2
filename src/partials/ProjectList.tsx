...
const ProjectList = () => (
  ...
  >
    <div className="flex flex-col gap-6">
      <Project
        name="C# Curly Formatter"
        description="VS Code extension that provides formatting fixes for C# development."
      ...
      <Project
        ...
        description="Sample project that shows how to use TiledCS to display Tiled maps in MonoGame. Featured in TiledCS repo readme."
