...
import { ShieldFull } from '@/partials/ShieldFull';
...
const ProjectList = () => (
  ...
  >
    <div className="flex flex-col gap-6">
      <Project
        name="cs-curly-formatter"
        description="Extension that provides a C# formatting fixes collection for VS Code."
        link="https://github.com/ironcutter24/cs-curly-formatter"
        img={{
        ...
        category={
          <>
            <Shield url="Formatter-%23239120.svg?style=flat&logoColor=white" />
      ...
      />
      <Project
        name="cs-state-machine"
        description="Flexible FSM with elegant syntax and support for hierarchical states."
        link="/"
