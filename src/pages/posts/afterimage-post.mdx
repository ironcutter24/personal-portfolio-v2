...
{frontmatter.title} is a 2D puzzle platformer where players control two characters on distinct planes of existence.<br />
They cannot interact with each other, and are blocked by walls of their same type (Solid and ghost).<br />
