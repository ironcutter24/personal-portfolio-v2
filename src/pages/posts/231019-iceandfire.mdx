...
<StoreLinkBanner
  girlUrl='https://github.com/FrozenFireGames/Heat-Change-Game'
/>
...
<Collapsible title="Scrum managed team">
  The work was done in a scrum managed team,
  using tools like Trello and Discord to keep track of tasks and communicate with the team.
</Collapsible>
